...
{
    public partial class aspnetmedByteApiContext : DbContext 
    {
        public aspnetmedByteApiContext()
        {
        }

        public aspnetmedByteApiContext(DbContextOptions<aspnetmedByteApiContext> options)
            : base(options)
        {
        }
        public virtual DbSet<CategoryTree> CategoryTree { get; set; }
        public virtual DbSet<CategoryParents> CategoryParents { get; set; }
        public virtual DbSet<ProductsWithCategory> ProductsWithCategory { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Categories>(entity =>
            {
                ...
                entity.Property(e => e.CategoryParentId).HasDefaultValueSql("((1))");
            });
